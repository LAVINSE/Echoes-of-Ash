...
namespace EchoesOfAsh.Data
{
    ...
    public class CardData : SWIdentifiedObject
    {
        ...
        /// </summary>
        /// <param name="sanityType">현재파티 정신력 타입</param>
