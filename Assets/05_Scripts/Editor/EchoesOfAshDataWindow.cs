...
namespace EchoesOfAsh.EditorTools
{
    ...
    public class EchoesOfAshDataWindow : EditorWindow
    {
        ...
        // 목록형 관리 대상 (탭 순서와 동일)
        private static readonly Type[] ManagedTypes = { typeof(CardData), typeof(CharacterData), typeof(EnemyData), typeof(SanityEventData), typeof(StatusEffectData), typeof(RelicData) };
        private static readonly string[] ManagedTabNames = { "카드", "캐릭터", "적", "정신력 이벤트", "상태이상", "유물" };
        private static readonly string[] DefaultPaths =
        {
            ...
            "Assets/02_Res/Data/Relic",
        };
        private static readonly string[] DefaultPrefixes = { "Card_", "Character_", "Enemy_", "SanityEvent_", "Status_", "Relic_" };
        // 단일 에셋 탭 (목록형 다음 순서)
